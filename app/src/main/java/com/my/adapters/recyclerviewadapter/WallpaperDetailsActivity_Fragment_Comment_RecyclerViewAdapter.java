...
import com.snakeway.ui.recyclerviewlibrary.adapters.LoadMoreLayerRecyclerViewAdapter;
import com.snakeway.ui.recyclerviewlibrary.models.ViewItem;
import com.snakeway.ui.recyclerviewlibrary.models.ViewLayerItem;
import com.snakeway.ui.utils.NetworkImageViewHelp;
import com.snakeway.ui.views.RoundedNetworkImageView;
import com.my.snakeway.ChildCommentActivity;
import com.my.snakeway.HotCommentActivity;
import com.my.snakeway.R;
import com.my.snakeway.WallpaperDetailsActivity;
import com.my.snakeway.fragment.WallpaperDetailsActivity_Fragment_Comment;
import com.my.snakeway.uihelp.PopupWindowHelp;
...
public class WallpaperDetailsActivity_Fragment_Comment_RecyclerViewAdapter extends LoadMoreLayerRecyclerViewAdapter {
    ...
    public int getNormalLayoutId(int viewType) {
        if (viewType == ViewItem.VIEW_TYPE_NORMAL_ITEM_TYPE1 || viewType == ViewItem.VIEW_TYPE_NORMAL_ITEM_TYPE4) {
            ...
            return com.snakeway.R.layout.snakeway_recyclerview_lostviewtype_item;
        }
    }
