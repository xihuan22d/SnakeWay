...
import com.snakeway.ui.recyclerviewlibrary.adapters.LoadMoreRecyclerViewAdapter;
import com.snakeway.ui.recyclerviewlibrary.models.ViewItem;
import com.snakeway.ui.utils.SnakeWayManager;
import com.my.snakeway.BreakpointDownloadActivity;
...
public class BreakpointDownloadListActivity_RecyclerViewAdapter extends LoadMoreRecyclerViewAdapter {
                        ...
                        public void onClick(View v) {
                            if (wallpaper.getDownloadingStatus() == Wallpaper.DOWNLOADING) {
                                ...
                                if (breakpointDownloadRequest != null) {
                                    SnakeWayManager.getInstance(baseActivity).cancelRequestWithRequest(breakpointDownloadRequest, true);
    ...
    private void goToDownload(Wallpaper wallpaper, String url) {
        ...
        SnakeWayManager.getInstance(baseActivity).addRequest(breakpointDownloadRequest);
