package com.snakeway.ui.recyclerviewlibrary.views;
...
public class BaseRecyclerViewFromFrameLayout extends FrameLayout {
    ...
    private int mainId = R.layout.snakeway_layout_main;
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        try {
            mainId = typedArray.getResourceId(R.styleable.extendedRecyclerView_layout_main, R.layout.snakeway_layout_main);
                ...
                public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                    if (newState == RecyclerView.SCROLL_STATE_IDLE) {
                        if (requestStatusItem != null) {
                            SnakeWayManager.getInstance(baseActivity).removeRequestStatusItem(requestStatusItem);
                            requestStatusItem = null;
                        }

                    } else {
                        if (requestStatusItem == null) {
                            requestStatusItem = SnakeWayManager.getInstance(baseActivity).addRequestStatusItem(RequestStatusItem.STATUS_PAUSE, RequestStatusItem.KIND_BITMAP_REQUEST, baseActivity.activityKey);
                        }
                    }
                }
            });
