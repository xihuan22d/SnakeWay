...
import com.snakeway.ui.imagechooselibrary.adapters.ChooseImageActivity_ListViewAdapter;
import com.snakeway.ui.imagechooselibrary.adapters.ChooseImageActivity_RecyclerViewAdapter;
import com.snakeway.ui.imagechooselibrary.models.ImageFolder;
import com.snakeway.ui.imagechooselibrary.models.ImageItem;
import com.snakeway.ui.imagechooselibrary.utils.SdcardDataSourceHelper;
import com.snakeway.ui.recyclerviewlibrary.models.ViewItem;
import com.snakeway.ui.recyclerviewlibrary.views.BaseRecyclerViewFromFrameLayout;
...
public class ChooseImageActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.snakeway_activity_chooseimage);
    ...
    public void chooseImageActivity_showSelectTypePopupWindow(final ChooseImageActivity chooseImageActivity, View view, final View needEnableView, List<ImageFolder> imageFolders, int selectPosition, final AdapterView.OnItemClickListener adapterViewOnItemClickListener) {
        ...
        View popupWindowView = layoutInflater.inflate(R.layout.snakeway_activity_chooseimage_popupwindow_selecttype, null);
        int snakeway_activity_chooseimage_relativeLayoutTop_height = chooseImageActivity.getResources().getDimensionPixelSize(
                R.dimen.snakeway_activity_chooseimage_relativeLayoutTop_height);
        final String popupWindowKey = "popupWindowKey" + TimeTool.getOnlyTimeWithoutSleep();
        int height = (int) ((BaseActivity.getScreenHeight(chooseImageActivity) - chooseImageActivity.getStatusBarHeight() - snakeway_activity_chooseimage_relativeLayoutTop_height * 2) * 0.6f);
        ...
        chooseImageActivity.getWindow().setAttributes(windowManagerLayoutParams);
        int marginBottom = snakeway_activity_chooseimage_relativeLayoutTop_height + chooseImageActivity.getNavigationBarHeight();
