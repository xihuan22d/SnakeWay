...
import com.snakeway.network.BitmapConfig;
import com.snakeway.network.BitmapRequest;
import com.snakeway.network.BitmapRequest_Default;
...
import com.snakeway.network.utils.gif.GifBitmap;
...
public class NetworkGifImageView extends AppCompatImageView {
    ...
    private SnakeWayManager snakeWayManager;
    ...
    private void init(Context context) {
        ...
        snakeWayManager = BaseActivity.getSnakeWayManager(context);
    ...
    private void addOrCancelBitmapRequest(int type, BitmapRequest<?> bitmapRequest) {
        RequestManager requestManager = snakeWayManager.getRequestManager();
